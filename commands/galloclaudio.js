...
const playSong = (voiceConnection) => {
	...
	const fileName = `../assets/sounds/galloclaudio.mp3`;
...
module.exports = {
	data: new SlashCommandBuilder().setName("galloclaudio").setDescription("No me parece que este chico sea muy listo"),
